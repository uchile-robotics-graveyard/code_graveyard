...
class GrabObject(smach.State):
    ...
    def __init__(self):
        smach.State.__init__(self, outcomes=['succeeded','notGrabbed','aborted','preempted'],
                             input_keys=['position'],
...
if __name__ == '__main__':
    ...
    sis = smach_ros.IntrospectionServer('grasppbj', sm, '/grasppbjSM')
    sis.start()
