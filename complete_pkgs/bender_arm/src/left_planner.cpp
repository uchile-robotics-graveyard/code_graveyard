 ...
 nh()
{
	...
	cartesian_service = nh.advertiseService("/left_arm/plan_cartesian", &Uarm::GoalCartesianService,this);
	grasp_service = nh.advertiseService("/left_arm/grasp", &Uarm::GraspService,this);
	state_service = nh.advertiseService("/left_arm/plan_state", &Uarm::GoalStateService,this);
	gripang_service = nh.advertiseService("/left_arm/mover_grip_ang", &Uarm::MoverGripAngService,this);
	munecaang_service = nh.advertiseService("/left_arm/mover_muneca_ang", &Uarm::MoverMunecaService,this);
	abrirgrip_service = nh.advertiseService("/left_arm/abrir_grip", &Uarm::AbrirGripBrazoService,this);
	cerrargrip_service = nh.advertiseService("/left_arm/cerrar_grip", &Uarm::CerrarGripBrazoService,this);
	orientargrip_service = nh.advertiseService("/left_arm/orientar_grip", &Uarm::OrientarGripService,this);
	posicion_reposo_service = nh.advertiseService("/left_arm/posicion_reposo", &Uarm::PosicionReposoService,this);
	salir_posicion_reposo_service = nh.advertiseService("/left_arm/salir_posicion_reposo", &Uarm::SalirPosicionReposoService,this);
	posicion_inicial_service = nh.advertiseService("/left_arm/posicion_inicial", &Uarm::PosicionInicialService,this);
	posicion_pre1_service = nh.advertiseService("/left_arm/posicion_premanipulacion1", &Uarm::PosicionPre1Service,this);
	posicion_pre2_service = nh.advertiseService("/left_arm/posicion_premanipulacion2", &Uarm::PosicionPre2Service,this);
	posicion_post1_service = nh.advertiseService("/left_arm/posicion_postmanipulacion1", &Uarm::PosicionPost1Service,this);
	torque_enable_service = nh.advertiseService("/left_arm/torque_enable", &Uarm::TorqueEnableService,this);
	feedback_service = nh.advertiseService("/left_arm/feedback", &Uarm::FeedbackService, this);
	grasp_feedback_service = nh.advertiseService("/left_arm/feedback_grasp", &Uarm::GraspFeedbackService, this);

	entregar_papel_service = nh.advertiseService("/left_arm/entregar_papel", &Uarm::EntregarPapelService,this);

	command_pub = nh.advertise<bender_msgs::Command>("left_arm_joints/command", 1000);
...
bool Uarm::GoalCartesianService(bender_srvs::PlanningGoalCartesian::Request &req,bender_srvs::PlanningGoalCartesian::Response &res){
	MoverBrazoB(req.x,req.y,req.z,1,false);
	double qi[4];
...
bool Uarm::GraspService(bender_srvs::PlanningGoalCartesian::Request &req,bender_srvs::PlanningGoalCartesian::Response &res){
	MoverBrazoB(req.x,req.y,req.z,1,true);
	double qi[4];
	while(leerPoseServo(qi))
		;
	MoverMotor(qi[0]-0.04,0.05,0);
...
bool Uarm::FeedbackService(bender_srvs::Feedback::Request &req, bender_srvs::Feedback::Response &res){
	...
	if(lastx==0 || lasty==0 || lastz==0)
		CinematicaDirecta(qi,pos);
	MoverBrazoB(pos[0]+req.xerr,pos[1]+req.yerr,pos[2]+req.zerr,1,false);
	return true;
}
bool Uarm::GraspFeedbackService(bender_srvs::Feedback::Request &req,bender_srvs::Feedback::Response &res){
	...
	MoverBrazoB(pos[0]+req.xerr,pos[1]+req.yerr,pos[2]+req.zerr,1,true);
	return true;
}
...
bool Uarm::MoverBrazoB(double x, double y, double z, int Brazo, bool PlanGrip){
	...
	alarm(10);
	tr = AppStar(qi,po,Map,1,&success,PlanGrip);
	alarm(0);
...
void Uarm::AccionarBrazoSpline(double *tr,int Brazo){
	...
	//SetPIDGain(32,0,"hombro_2");
	//SetPIDGain(32,0,"codo_1");
	//SetPunch("hombro_2",0);
	//SetPunch("codo_1",0);
	...
	while(n<1 && ros::ok()){
		...
		//SetComplianceSlope("hombro_1",slope);
		//SetComplianceSlope("codo_1",slope);
		//int ID = SelectIDLevel(tiempo,t);
		//SetPIDGain(32,ID,"hombro_2");
		//SetPIDGain(32,ID,"codo_1");
		//Reloj.Start();
...
void Uarm::AccionarBrazo(double *tr,int Brazo){
	...
	while(it<n && ros::ok()){;
		...
		//SetPIDGain(32,32,"hombro_2");
		//SetPIDGain(32,32,"codo_1");
		ROS_INFO("Pose brazo: %f, %f, %f, %f\n",angulo[0],angulo[1],angulo[2],angulo[3]);
...
void Uarm::MoverMuneca(double angulo, double velocidad){
	...
	//FUNCION DE ROS PARA MOVER muneca.
	//ros::Publisher command_pub = nh.advertise<bender_planning_old::Command>("left_arm_joints/command", 1000);
...
void Uarm::torqueOnOff(int OnOff){
	...
	while(!ros::service::waitForService("left_arm_joints/torque_enable", ros::Duration(1.0)) && ros::ok())
	{
		ROS_INFO_STREAM("Waiting for planner service left_arm_joints/torque_enable");
	}

	ros::ServiceClient client = nh.serviceClient<bender_srvs::TorqueEnable>("left_arm_joints/torque_enable");
	...
	for(int i=0; i<6;i++)
	{
		...
		if (!client.call(srv))
			ROS_ERROR("Failed to call service left_arm_joints/torque_enable in Uarm::torqueOnOff");
	}
}
void Uarm::torqueMotorOnOff(string name,int OnOff){
	...
	srv.request.torque_enable=OnOff;
	if (!client.call(srv))
		ROS_ERROR("Failed to call service left_arm_joints/torque_enable in Uarm::torqueMotorOnOff");

}
void Uarm::SetPIDGain(int P, int ID, string name){
	while(!ros::service::waitForService("left_arm_joints/set_compliance_slope", ros::Duration(1.0)) && ros::ok())
	{
		ROS_INFO_STREAM("Waiting for planner service left_arm_joints/set_compliance_slope");
		ROS_INFO_STREAM("Waiting for planner service left_arm_joints/set_compliance_margin");
	}
	ros::ServiceClient client_slope = nh.serviceClient<bender_srvs::Slope>("left_arm_joints/set_compliance_slope");
	ros::ServiceClient client_margin = nh.serviceClient<bender_srvs::Margin>("left_arm_joints/set_compliance_margin");
	...
	if (!client_slope.call(srv))
		ROS_ERROR("Failed to call service left_arm_joints/set_compliance_slope in Uarm::SetPIDGain");
	if (!client_margin.call(srv2))
		ROS_ERROR("Failed to call service left_arm_joints/set_compliance_margin in Uarm::SetPIDGain");
}
/*void Uarm::SetComplianceSlope(string name,int slope){
	...
	ros::ServiceClient client = nh.serviceClient<bender_srvs::Slope>("left_arm_joints/set_compliance_slope");
	bender_srvs::Slope srv;

	srv.request.motor_name = name;
	srv.request.slope = slope;
	if (!client.call(srv))
		ROS_ERROR("Failed to call service left_arm_joints/set_compliance_slope in Uarm::SetComplianceSlope");
}
void Uarm::SetAllComplianceSlope(int slope){
	...
	for(int i=0; i<8;i++)
	{
		...
		srv.request.slope = slope;
		if (!client.call(srv))
			ROS_ERROR("Failed to call service left_arm_joints/set_compliance_slope in Uarm::SetAllComplianceSlope");
	}
}
...
void Uarm::SetPunch(string name,int value){
	...
	while(!ros::service::waitForService("left_arm_joints/set_compliance_punch", ros::Duration(1.0)))
	{
		ROS_INFO_STREAM("Waiting for planner service left_arm_joints/set_compliance_punch");
	}
	ros::ServiceClient client = nh.serviceClient<bender_srvs::Punch>("left_arm_joints/set_compliance_punch");
	bender_srvs::Punch srv;
	srv.request.motor_name = name;
	srv.request.punch = value;
	if (!client.call(srv))
		ROS_ERROR("Failed to call service left_arm_joints/set_compliance_punch in Uarm::SetPunch");
}
void Uarm::SetAllPunch(int value)
{
	...
	for(int i=0; i<8;i++)
	{
		...
		srv.request.punch = value;
		if (!client.call(srv))
			ROS_ERROR("Failed to call service left_arm_joints/set_compliance_punch in Uarm::SetAllPunch");
	}
}
...
void Uarm::OrientarGrip(void)
{
	...
	//ANGULO EN EL QUE SE DEBE ROTAR codo_2 (ROLL)
	double anguloZ = -1*asin(matrizRot[2][1]); // Esto es la componente Z(XYZ) de V(UVW)
	//ANGULO EN EL QUE SE DEBE ROTAR muneca (PITCH)
	double anguloY = -1*asin(matrizRot[2][2]); //Esto es la componente Z(XYZ) de W(UVW)
	// Enviar el comando al servo del codo_2 y muneca
	//FUNCION DE ROS PARA PUBLICAR ANGULO DE LA muneca Y EL CODO
	bender_msgs::Command com;
	com.positions.resize(8);
	com.select.resize(8);
	com.speed.resize(8);
	for(int i=0;i<8;i++)
	{
		...
		if(i==4) //codo_2
		{
			//ROS_INFO("Llenando mensaje para codo 2: %f",anguloZ);
		...
		if (i==5) //muneca
		{
			//ROS_INFO("Llenando mensaje para muneca: %f",anguloY);
...
//======== control de torque para gripper brazo derecho =======
	...
	else loadMax=0.55; //Si modo fuerte
...
bool Uarm::BrazoMov(int Brazo)
{
	...
	if(Brazo==1)
		return (leerMoving("hombro_1") ||
				 leerMoving("hombro_2") ||
				 leerMoving("muneca") ||
				 leerMoving("hombro_3") ||leerMoving("codo_1") ||
				 leerMoving("dedo_2") || leerMoving("dedo_1"));
...
int Uarm::leerPoseServo(double qi[])
{
	...
	while(!ros::service::waitForService("left_arm_joints/states", ros::Duration(1.0)) && ros::ok() && ros::ok())
	{
		ROS_INFO_STREAM("Waiting for planner service left_arm_joints/states");
	}
	//ROS_INFO("Servicio left_arm_joints/states encontrado");
	ros::ServiceClient client = nh.serviceClient<bender_srvs::States>("left_arm_joints/states");
	...
	{
		ROS_ERROR("Failed to call service left_arm_joints/states in Uarm::leerPoseServo");
	return 1;
	}
	return 0;
}
void Uarm::planificadorDirecto(double qi[],double qo[])
{
	...
	//ros::Publisher command_pub = nh.advertise<bender_msgs::Command>("left_arm_joints/command", 1000);
...
void Uarm::CinematicaDirecta(double state[], double pos[]){
	...
	*/
	...
	TF[0]=ca1*ca3*ca4+sa1*(sa2*sa3*ca4-ca2*sa4);
	TF[1]=sa1*sa2*ca3-ca1*sa3;
	TF[2]=ca1*ca3*sa4+sa1*(ca2*ca4+sa2*sa3*sa4);
	TF[3]=ca1*(ca3*(-1.45*ca4-35.6*(sa4-0.014045))+1.4)+sa1*(ca2*(-35.6*ca4+1.45*sa4-34)+sa2*sa3*(-1.45*ca4-35.6*(sa4-0.014045))-3.55);

	TF[4]=ca2*sa3*ca4+sa2*sa4;
	TF[5]=ca2*ca3;
	TF[6]=ca2*sa3*sa4-sa2*ca4;
	TF[7]=ca2*sa3*(-1.45*ca4-35.6*(sa4-0.014045))+sa2*(35.6*ca4-1.45*sa4+34)+3.85;

	TF[8]=ca1*(sa2*sa3*ca4-ca2*sa4)-sa1*ca3*ca4;
	TF[9]=sa1*sa3+ca1*sa2*ca3;
	TF[10]=ca1*(ca2*ca4+sa2*sa3*sa4)-sa1*ca3*sa4;
	TF[11]=ca1*(ca2*(-35.6*ca4+1.45*sa4-34)+sa2*sa3*(-1.45*ca4-35.6*(sa4-0.014045))-3.55)+sa1*(ca3*(1.45*ca4+35.6*(sa4-0.014045))-1.4);
...
void Uarm::CinematicaDirectaGrasp(double state[], double pos[]){
	...
	double anguloYmuneca=asin(TF[10]);
	double anguloZmuneca=asin(TF[9]);
	...
	//Punta del grip en coord (0,0,-16) respecto de la muneca
