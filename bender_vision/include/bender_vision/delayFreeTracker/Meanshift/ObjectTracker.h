...
#define CMCAO m_cActiveObject
//#define CMCAO 0
	int w() {return m_sTrackingObjectTable[CMCAO].W;}
	int h() {return m_sTrackingObjectTable[CMCAO].H;}
	int x() {return m_sTrackingObjectTable[CMCAO].X - w()/2;}
	int y() {return m_sTrackingObjectTable[CMCAO].Y - h()/2;}
